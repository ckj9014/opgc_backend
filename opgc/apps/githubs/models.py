...
class GithubUser(CustomBaseModel):
    ...
    username = models.CharField(unique=True, max_length=200, null=False, help_text='Github ID')
    ...
    user_rank = models.IntegerField(default=None, null=True)
    company = models.CharField(max_length=100, default=None, null=True, blank=True)
    bio = models.CharField(max_length=200, default=None, null=True, blank=True, help_text='설명')
    ...
    continuous_commit_day = models.IntegerField(default=0, help_text='1일 1커밋 지속 날짜 카운트')
